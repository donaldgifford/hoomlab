...
- **[The runbook](../../docs/runbook/bootstrap-cluster.md)** — the
  step-by-step operator procedure: every command, its expected output,
  and what to check between stages. Follow that when actually building
  a cluster; this file is the CLI reference.
- **[INV-0001](../../docs/investigation/0001-bootstrap-cli-hardware-acceptance-drill.md)**
  — the hardware acceptance drill: what still has to be proven on real
  hardware, the result and convergence tables to fill in, and the
  defects found so far.
- **[IMPL-0001](../../docs/impl/0001-bootstrap-cli.md)** — phase
  tracking. **[DESIGN-0001](../../docs/design/0001-bootstrap-cli.md)**
  — why any of it is shaped this way.
