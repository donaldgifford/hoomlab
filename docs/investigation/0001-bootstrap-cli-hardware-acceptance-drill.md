...
| --- | --- |
| bootstrap CLI | built from `f4ba8d5` (`feat/impl-hardware-drill`, clean tree) via `just bootstrap-build` → `build/bin/bootstrap` (prior builds `4b443ea`, `b7968c4`, `99b9416` retired by fold-backs) |
